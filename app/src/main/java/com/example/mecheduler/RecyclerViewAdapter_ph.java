...
public class RecyclerViewAdapter_ph extends RecyclerView.Adapter<RecyclerViewAdapter_ph.ViewHolder> {
    ...
    public RecyclerViewAdapter_ph(Context context, ArrayList<LikeHospital> datas, OnListItemSelectedInterface listener) {
        this.mDatas = datas;
        this.mListener = listener;
        this.mInflater = LayoutInflater.from(context);
    }

    public RecyclerViewAdapter_ph(Context context, ArrayList<LikeHospital> datas) {
        this.mDatas = datas;
        this.mInflater = LayoutInflater.from(context);
    }
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.postimg.setImageResource(R.drawable.phicon);
